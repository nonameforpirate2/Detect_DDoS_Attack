...
if __name__ == '__main__':
    ...
    device_name = config['tcs_hackaton']['device_name']['GPS_Locator'][1]
    topic = config['tcs_hackaton']['topic_type'][13]
    path_to_watch = config['tcs_hackaton']['paths']['GPS_Locator_2_send']
    attribute_to_measure = "lat"
