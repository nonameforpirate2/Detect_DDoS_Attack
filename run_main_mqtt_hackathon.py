...
topic_fridge_1 = config['tcs_hackaton']['topic_type'][0]
topic_fridge_2 = config['tcs_hackaton']['topic_type'][1]
topic_fridge_3 = config['tcs_hackaton']['topic_type'][2]
...
client.publish(topic_fridge_1, payload="hot", qos=1)
