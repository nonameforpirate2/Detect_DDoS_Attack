...
if __name__ == '__main__':
    ...
    device_name = config['tcs_hackaton']['device_name']['Motion_Light'][0]
    path_to_save_data = config['tcs_hackaton']['paths']['Motion_light_1_collection']
    topic = config['tcs_hackaton']['topic_type'][6]
