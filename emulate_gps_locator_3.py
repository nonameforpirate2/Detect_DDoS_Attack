...
if __name__ == '__main__':
    ...
    device_name = config['tcs_hackaton']['device_name']['GPS_Locator'][2]
    topic = config['tcs_hackaton']['topic_type'][14]
    path_to_watch = config['tcs_hackaton']['paths']['GPS_Locator_3_send']
