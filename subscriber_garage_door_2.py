...
if __name__ == '__main__':
    ...
    device_name = config['tcs_hackaton']['device_name']['Garage_Door'][1]
    path_to_save_data = config['tcs_hackaton']['paths']['Garage_door_2_collection']
    topic = config['tcs_hackaton']['topic_type'][4]
