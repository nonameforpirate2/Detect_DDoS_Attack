...
if __name__ == '__main__':
    ...
    device_name = config['tcs_hackaton']['device_name']['IoT_weather'][2]
    path_to_save_data = config['tcs_hackaton']['paths']['Iot_weather_3_collection']
    topic = config['tcs_hackaton']['topic_type'][23]
