...
if __name__ == '__main__':
    ...
    device_name = config['tcs_hackaton']['device_name']['Garage_Door'][2]
    topic = config['tcs_hackaton']['topic_type'][5]
    path_to_watch = config['tcs_hackaton']['paths']['Garage_door_3_send']
    attribute_to_measure = "door state"
    # Create instance of device and emulate process.
