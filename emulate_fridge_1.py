...
if __name__ == '__main__':
    ...
    device_name = config['tcs_hackaton']['device_name']['Fridge'][0]
    topic = config['tcs_hackaton']['topic_type'][0]
    path_to_watch = config['tcs_hackaton']['paths']['Fridge_1_send']
    attribute_to_measure = "Fridge_Temperature"
